...
---
    ...
    Output
      [1] "es bonita esta ecuación? Ten en cuenta que$\\alpha=1$y$b$no están definidos."
...
# deepl_translate() handles equations+footnote well
    ...
    Code
      foot_math_lines
    Output
      [1] "See$a$      for an equation followed by a footnote      ,      and      [^1]      ."
      [2] ""                                                                                   
      [3] "[^1]:      a footnote."                                                             
      [4] ""                                                                                   
      [5] ""                                                                                   
...
# deepl_translate() protects fenced divs
    ...
    Output
      ...
      [2] ""                                                   
      [3] "::: footer      [¡Qué]"                             
      [4] "      [astuto eres!]{style=\"color: transparent;\"}"
      [5] ":::"                                                
      [6] ""                                                   
      [7] ""                                                   
